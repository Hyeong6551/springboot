...
%>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container px-4 px-lg-5">
            <a class="navbar-brand" href="/">Hyeong's shop</a>
            <div class="collapse navbar-collapse">
            	...
            	%>
     	        <form class="d-flex ">
                    <a class="btn btn-outline-dark ms-2"  href="${pageContext.request.contextPath}/login">로그인</a>
                    <a class="btn btn-outline-dark ms-2"  href="${pageContext.request.contextPath}/register">회원가입</a>
                </form>
            	<%
            	} else {
            		%>
